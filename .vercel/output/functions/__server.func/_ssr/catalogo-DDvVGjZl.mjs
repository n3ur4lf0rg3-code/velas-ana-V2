...
import { g as cn, t as Ornament } from "./ornament-BtZfPFdQ.mjs";
import { a as Route$7 } from "./router-XIM6apER.mjs";
import { t as SHAPES } from "./products-BBFMn6GJ.mjs";
import { r as ProductCard } from "./product-card-CECIYEZO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/catalogo-DDvVGjZl.js
...
function CatalogPage() {
	const { forma, aroma, color } = Route$7.useSearch();
	const navigate = Route$7.useNavigate();
	const { products, scents, colors } = Route$7.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Filtra por forma, aroma o color. Todas las piezas se hacen por lote pequeño y se reservan al confirmar la transferencia."
			}),
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {
							...
							children: "Todos"
						}), colors.filter((item) => usedColors.has(item.id)).map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {
							active: color === item.id,
							onClick: () => navigate({ search: {
								forma,
								aroma,
								color: color === item.id ? void 0 : item.id
							} }),
							children: item.name
						}, item.id))]
					})] })
