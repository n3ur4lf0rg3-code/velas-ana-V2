  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Velas aromáticas artesanales esculpidas a mano. Rosas, frappés, wax melts y formas decorativas.",
      },
...
function NotFound() {
  return (
    <main className="px-4">
      ...
      >
        El enlace se perdió entre las velas. Te llevamos de regreso a la casa.
      </EmptyState>
    </main>
  );
}
